...
class GameLobby{
    ...
    public static function fcLaunchUrl($game_code,$token,$exitUrl,$provider,$lang="en"){
        ...
        $data = FCHelper::loginGame($client->player_id,$game_code,1,$exitUrl,$client);
    ...
    public static function tidylaunchUrl( $game_code = null, $token = null){
     ...
     public static function pgvirtual($request){
        ...
        if(Helper::isValidUUID($pg_uuid)) {
            ...
            Helper::saveLog('PGVirtual gamelaunch invalid uuid',48, $request["token"], $pg_uuid);
            return $request["exitUrl"];
        }
    ...
    public static function pgsoftlaunchUrl( $game_code = null, $token = null){
        ...
        $url = "https://m.pgjkjk.club/".$game_code."/index.html?language=en-us&bet_type=1&operator_token=".urlencode($operator_token)."&operator_player_session=".urlencode($token);
        return $url;
    }
