...
// Bole Gaming
class BoleGamingControllerNew extends Controller
{
		     ...
		     //           		->update(['pay_amount' => $pay_amount, 
			    ...
			    // 			]);
						...
						{	
			                ...
			                GameTransactionMDB::createGameTransactionExtV2($gametransactionext,$game_transextension,$client_details);
							...
							try {
							    ...
							    $createGameTransactionLog = [
				                    ...
				                    "column" =>[
				                        ...
				                        "request" => json_encode($e->getMessage()),
				                        "response" => json_encode($data),
				                        "log_type" => "provider_details",
				                        "transaction_detail" => json_encode($general_details),
				                    ]
				                ];
			                ...
			                if(isset($client_response->fundtransferresponse->status->code) 
							    ...
							    $createGameTransactionLog = [
				                    ...
				                    "column" =>[
				                        "game_trans_ext_id" => $game_transextension,
				                        "request" => json_encode($client_response),
				                        "response" => json_encode($data),
				                        "log_type" => "provider_details",
				                        "transaction_detail" => json_encode($general_details),
				                    ]
