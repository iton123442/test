...
class DOWINNNEWController extends Controller{
        ...
        if($client_details){
            ...
            if($playerChecker['code'] == 0 && $playerChecker['ingame'] == true){
                ...
                if($bet_transaction != null){
                    ...
                    GameTransactionMDB::updateGametransactionV2($updateTransaction,$game_trans_id,$client_details);
                    $gametransExt_data = [
                    ...
                    && $client_response->fundtransferresponse->status->code == "200"){
                        ...
                        GameTransactionMDB::updateGametransactionV2($updateTransData,$game_trans_id,$client_details);
                        $response = [
                            "status" => 'OK',
                            "balance" => $balance,
                            "uuid" => $data['uuid'],
                    ...
                    && $client_response->fundtransferresponse->status->code == "402"){
                        try{    
                            ...
                            GameTransactionMDB::updateGametransactionV2($updateTrans,$game_trans_id,$client_details);
                            $response = [
                                "code" => 51,
                ...
                GameTransactionMDB::createGametransactionV2($gameTransactionDatas,$game_trans_id,$client_details);
                $gameExtensionData = [
                    "game_trans_id" => $game_trans_id,
                    "provider_trans_id" => $transId,
                    "round_id" => $roundId,
    ...
    public function paymentNewProcessor($data,$client_details, $explodedOrderId){
        ...
        if($client_details){
            ...
            if($game == null){
                Helper::saveLog("NO BET FOUND", 139,json_encode($data),"HIT!");
                $game_trans_id = ProviderHelper::idGenerate($client_details->connection_name,1);
                $game_trans_ext_id = ProviderHelper::idGenerate($client_details->connect_name,2);
                $gameTransactionDatas = [
                    "provider_trans_id" => $transId,
                    "token_id" => $client_details->token_id,
                    "game_id" => $gamedetails->game_id,
